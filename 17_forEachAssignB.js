...
console.log(`1. Find out the TCS employees details and log only name & comapany on console`); 
...
console.log(`2. Find the employees with salary grater than or equal 50000.`); 
...
let sumAllSalary = 0;
array_employees.forEach( (employee) => {
    sumAllSalary = sumAllSalary + employee.emp_salary;
});
console.log(sumAllSalary);



console.log(`4.Find the sum of all employees salary.`); 
...
console.log(`5.Find the sum of all employees salary`); 
