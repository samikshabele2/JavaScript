...
console.log(`2. Check and log type of function(Hint-typeOf VariavleName`);
console.log("type of the square");


console.log("write a function expression to get the area of rectangle plot[length = 499 and width = 917]");
...
console.log("Write a Function Expression with two args and should swap the passed value and log on console before swap and after swap values inside function itself");
...
console.log(`Step 5:Write a function expression which can perform the below steps for string:`);
