...
console.log("1. The List of Employee Names");
const empNames = array_employess.map( (employee)=> {
    return employee.emp_name;
} );
console.log(empNames);
console.log(" ");

console.log("2. The List of Department Names");
...
let empNames2 = array_employess.map((element)=>{
